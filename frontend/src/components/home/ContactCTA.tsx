...
export default function ContactCTA() {
  ...
  return (
    <section ref={ref} className="relative py-28 overflow-hidden" style={{ background: '#0A0A0A' }} dir="rtl">
      ...
      <div className="section-container relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="max-w-2xl mx-auto text-center">
          <div className="section-tag justify-center">ارتباط با ما</div>
          <h2 className="text-3xl md:text-5xl font-black text-white mb-5 leading-tight">
            آماده شروع <span className="text-gold-gradient">پروژه</span> خود هستید؟
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:02112345678" className="btn-outline-luxury">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
